...
@Component({
    selector: 'ngx-add-booking-event',
    templateUrl: './booking-event-add.component.html',
    styleUrls: ['./booking-event-add.component.scss'],
})
export class BookingEventAddComponent implements OnInit {
