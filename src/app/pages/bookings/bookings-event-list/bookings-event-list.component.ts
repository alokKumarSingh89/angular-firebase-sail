...
@Component({
  selector: 'ngx-booking-event-list',
  templateUrl: 'bookings-event-list.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush
})



export class BookingEventListComponent implements OnInit {
  name: string;
  colors: any = {
    red: {
      primary: '#ad2121',
    ...
    this._pagesService.getNodes("Bookings").subscribe(
      data => {
        ...
        for (var key in data) {
          ...
          if (data[key].fields['eventID'] !== undefined) {
            ...
            if (this.facilityId != '') {
              if (tempData.eventID == this.facilityId) {
